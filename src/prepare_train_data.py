...
if __name__ == "__main__":
    ...
    # DATASET_PATH = os.path.join(ROOT_DIR, 'data/intern_screening_dataset.csv')  # SET THE PATH
    # MODEL_CHECKPOINT = 'distilbert-base-cased-distilled-squad' # CORRECTED to match train.py
    
    # # Define path for the unified knowledge base
    # KNOWLEDGE_BASE_PATH = os.path.join(ROOT_DIR, 'data/knowledge_base_chunks.csv')
    
    # # Define paths for train/validation/test datasets
    # TRAIN_DATA_PATH = os.path.join(ROOT_DIR, 'data/squad_train_data.json')
    # VAL_DATA_PATH = os.path.join(ROOT_DIR, 'data/squad_val_data.json')
    # TEST_DATA_PATH = os.path.join(ROOT_DIR, 'data/squad_test_data.json')
